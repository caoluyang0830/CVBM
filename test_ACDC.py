...
parser.add_argument('--exp', type=str, default='BANET2d_B', help='experiment_name')
parser.add_argument('--model', type=str, default='BANET2d_B', help='model_name')
...
def Inference(FLAGS):
    ...
    snapshot_path = "../model/BANET/ACDC_{}_{}_labeled/{}".format(FLAGS.exp, FLAGS.labelnum, FLAGS.stage_name)
    test_save_path = ".。/model/BANET/ACDC_{}_{}_labeled/{}_predictions/".format(FLAGS.exp, FLAGS.labelnum, FLAGS.model)
    if os.path.exists(test_save_path):
        shutil.rmtree(test_save_path)
    os.makedirs(test_save_path)
    net = net_factory(net_type=FLAGS.model, in_chns=1, class_num=FLAGS.num_classes)
    # save_model_path = os.path.join(snapshot_path, '{}_best_model.pth'.format(FLAGS.model))
    save_model_path = "D:/python_projects/pytorch_segmentation/good/BANET5/ACDC_BANET2d_B_7_labeled/self_train/BANET2d_B_best_model.pth"
