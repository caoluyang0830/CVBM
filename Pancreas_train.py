...
from utils.data_aug_utils import context_mask, mix_loss, update_ema_variables,context_mask_pancreas
...
def pre_train(args, snapshot_path):
    ...
    for epoch_num in iterator:
        for _, sampled_batch in enumerate(trainloader):
            ...
            if iter_num % 200 == 0:
                model.eval()
                dice_sample = test_3d_patch.var_all_case_Pancreas(model, num_classes=num_classes, patch_size=patch_size, stride_xy=16, stride_z=16)
...
if __name__ == "__main__":
    ## make logger file
    pre_snapshot_path = "../model/BABINet/Pancreas_{}_{}_labeled/pre_train".format(args.exp, args.labelnum)
    self_snapshot_path = "../model/BABINet/Pancreas_{}_{}_labeled/self_train".format(args.exp, args.labelnum)
