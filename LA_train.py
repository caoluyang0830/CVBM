...
if __name__ == "__main__":
    ## make logger file
    pre_snapshot_path = "../model/CVBM/LA_{}_{}_labeled/pre_train".format(args.exp, args.labelnum)
    self_snapshot_path = "../model/CVBM/LA_{}_{}_labeled/self_train".format(args.exp, args.labelnum)
