...
parser.add_argument('--exp', type=str,  default='BANET_B_doublebg', help='exp_name')
...
snapshot_path = "../model/BANET_B_doublebg/LA_{}_{}_labeled/{}".format(FLAGS.exp, FLAGS.labelnum, FLAGS.stage_name)
test_save_path = "../model/BANET_B_doublebg/LA_{}_{}_labeled/{}_predictions/".format(FLAGS.exp, FLAGS.labelnum, FLAGS.model)
num_classes = 2
