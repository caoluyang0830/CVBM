...
parser.add_argument('--exp', type=str, default='BABINet2d', help='experiment_name')
parser.add_argument('--model', type=str, default='BABINet2d', help='model_name')
...
if __name__ == "__main__":
    ...
    # -- path to save models
    pre_snapshot_path = "../model/BABINet2d/ACDC_{}_{}_labeled/pre_train".format(args.exp, args.labelnum)
    self_snapshot_path = "../model/BABINet2d/ACDC_{}_{}_labeled/self_train".format(args.exp, args.labelnum)
