...
if __name__ == "__main__":
    ...
    # -- path to save models
    pre_snapshot_path = "../model/CVBM/ACDC_{}_{}_labeled/pre_train".format(args.exp, args.labelnum)
    self_snapshot_path = "../model/CVBM/ACDC_{}_{}_labeled/self_train".format(args.exp, args.labelnum)
